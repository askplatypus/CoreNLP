...
RUN wget http://nlp.stanford.edu/software/stanford-corenlp-full-2017-06-09.zip && \
    ...
    wget http://nlp.stanford.edu/software/stanford-arabic-corenlp-2017-06-09-models.jar && \
    ...
    wget http://nlp.stanford.edu/software/stanford-spanish-corenlp-2017-06-09-models.jar

ENV PORT 9000
EXPOSE $PORT

CMD java -cp "/stanford-corenlp-full-2017-06-09/*" -Xmx8g edu.stanford.nlp.pipeline.StanfordCoreNLPServer
