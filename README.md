Stanford CoreNLP for Platypus
================

This is a fork of Standford CoreNLP with some patch to make it work for Platypus.

## List of local changes
* Change French POS tagger to output Universal Dependency POS tags (they are the one requested by the French dependency parser).
